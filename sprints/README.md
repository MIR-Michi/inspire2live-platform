...
- [`sprint-19-adaptive-dashboard-design/`](sprint-19-adaptive-dashboard-design/description.md) — redesigns personal, team, admin, and role dashboards as spacious Campus-inspired two-zone workspaces with a shared widget registry, cross-device user preferences, accessible tile movement/sizing, presets, focus mode, friendly motion, and restrained task-completion celebration. See `docs/ADAPTIVE_DASHBOARD_DESIGN_CONCEPT.md`.
